...
import '../../../mafdy/lib/clinic_detail.dart';
import '../../../mafdy_samuel/lib/widgets/main_doctors.dart';
...
class BookCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [//DocCard(Doctor("image", "", Speciality("image", "name"), "address", 6, 9))
          InkWell(onTap: ()=>Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MainDoctors()  )),
            child: Row(
              children: [
                Container(
                  height: 70,
